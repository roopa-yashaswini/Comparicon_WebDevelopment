	...
	if(isset($_POST['send'])){
		...
		if($rows == 1){
			...
			if($send_status){
				...
				echo "<script>location.replace('admin_chat.php');</script>";
			}
		}else{
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="stylesheets/admin_chat_style.css?v=0" />
