...
<head>
	...
	<link rel="stylesheet" type="text/css" href="stylesheets/search_history_style.css?v=0" />
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
	<script src="javascript/functions.js?v=1"></script>
</head>

<body onload="get_history('<?php echo $_SESSION['username']; ?>')">
	<!--header of the page-->
	<div id="header">
		<div id="logo_place">
	...
	<!--Main content of the page (Recent searches table)-->
	<div id="main_content">
